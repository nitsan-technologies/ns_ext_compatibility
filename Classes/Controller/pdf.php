...
class PDF extends FPDF
{
	...
	function Header()
	{
		...
		$header = Localize::translate('typo3upgrad1', 'ns_ext_compatibility', array('sitename' => $sitename));
	    // Logo
	...
	function systemDetailsTable($sysDetail = NULL, $typo3Data = NULL)
	{
		...
		if($typo3Data['installedVersion']<$typo3Data['ltsVersion']) {
			$this->SetFont('','B', 12);
			$this->MultiCell(250,10,$this->translate('t3-ltsVersion' , array('s' => $typo3Data['ltsVersion'])),0,'L',FALSE);
			$this->Ln(5);
		}
	...
	function systemExtTable($extensionlist = NULL, $sysDetail = NULL, $overviewReport = NULL)
	{
	...
	function ServerDetailsTable($targetSystemRequirement = NULL)
	{
		$this->SetFont('','B', 12);
